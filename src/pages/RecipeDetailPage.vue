      ...
      <div class="flex flex-col gap-10">
        ...
        <div>
          ...
          <ul
            ...
            v-if="recipeStore.selectedRecipe?.extendedIngredients"
          >
            <li
              class="w-20"
              v-for="ingridient in recipeStore.selectedRecipe
                ?.extendedIngredients"
              :key="ingridient.id"
            >
              <router-link :to="`/ingridients/${ingridient.id}`">
                <img
                  class="bg-gray-700 h-20"
                  :src="
          ...
          <ul>
            ...
            >
              ...
              <ul class="flex flex-col gap-3">
                <li
                  class="bg-gray-800 p-5"
                  v-for="subItem in item.steps"
                  :key="subItem.number"
                >
                    ...
                    <div class="w-200">
                      ...
                      <div class="flex gap-4 mt-5 items-center">
                        ...
                        <ul class="flex gap-10 flex-wrap">
                          <li
                            v-for="ingridient in subItem.ingredients"
                            :key="ingridient.id"
                          >
                            <div v-if="ingridient.image">
                              <img
                                class="bg-gray-700 w-20 h-20"
                                :src="
                                  'https://spoonacular.com/cdn/ingredients_100x100/' +
                                  ingridient.image
                                "
